    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 ms-auto">
                <form class="form" method="get" action="{{ route ('cariEventAnggota') }}">
                    <div class="row">
                        <div class="col-md-6 ms-auto">
                            <input type="text" name="cariEventAnggota" class="form-control" value="{{ request('cariEventAnggota')}}" id="cariEventAnggota" placeholder="Cari ...">
                        </div>  
                        <div class="col-md-6 ms-auto">
