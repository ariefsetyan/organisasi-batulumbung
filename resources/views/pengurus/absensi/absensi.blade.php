        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="tanggal" placeholder="Masukkan Tanggal" readonly>
                    ...
                    <a href="{{ route ('rekapan-absensi') }}" class="btn btn-success my-3 text-light">REKAPAN ABSENSI</a>
                        ...
                        <table class="table table-striped" id="myTable">
                            ...
                            @foreach ($absensi as $result => $absen)
                                <tr>
                                    ...
                                    <td>{{$auth}}</td>
                                    <td>{{$absen->status}}</td>
                                    <td><a href="hapus_absen/{{$absen->id}}" class="btn btn-danger text-white"><i class="bi bi-trash-fill"></i></a></td>
                            @endforeach
                            </tbody>
                        </table>
                    </div>
